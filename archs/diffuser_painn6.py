...
class DiffusionDenoiser:
  ...
  def get_epsilon_pred(self, sigma, x_1_noised, nn_output):
  ...
  def _diffuser_step(self, x, metadata):
    ...
    epsilon_pred = self.get_epsilon_pred(sigma, x_1_noised, self.dn(t, x_0, x_1_noised, self.box, metadata))
  ...
  def generate(self, x_0, metadata, steps=32):
    *leading_dims, atoms, must_be[3] = x_0.shape
    ...
    for i in range(steps):
      ...
      epsilon_pred = self.get_epsilon_pred(sigma_t, ans, self.dn(t, x_0, ans, self.box, metadata))
