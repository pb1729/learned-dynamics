...
void fused_tensor_prods_example(
  ...
  fused_tensor_prods_example_kern<<<gridsz, blocksz, sharedmemsz*sizeof(float)>>>(
      ...
      x_0, x_1, x_2, P_000, left_000, P_011, left_011, P_101, left_101, P_110, left_110, P_220, left_220, P_222, left_222, P_211, left_211,
      y_0, y_1, y_2);
...
void fused_tensor_prods_example_backward(
  ...
  fused_tensor_prods_example_backward_kern<<<gridsz, blocksz, sharedmemsz*sizeof(float)>>>(
      p_0, p_1_base, p_1, p_2_base, p_2, 
      batch, dim_l, dim_0, dim_1, dim_2,
      dy_0, dy_1, dy_2, P_000, left_000, P_011, left_011, P_101, left_101, P_110, left_110, P_220, left_220, P_222, left_222, P_211, left_211,
      dx_0, dx_1, dx_2);
...
void fused_tensor_prods_example_backleft_kern(
    ...
    float* __restrict__ dleft_000, float* __restrict__ dleft_011, float* __restrict__ dleft_101, float* __restrict__ dleft_110, float* __restrict__ dleft_220, float* __restrict__ dleft_222, float* __restrict__ dleft_211) {
  extern __shared__ float s[];
  for (int idx_batch = blockIdx.x; idx_batch < batch; idx_batch += gridDim.x) {
...
void fused_tensor_prods_example_backleft(
  ...
  fused_tensor_prods_example_backleft_kern<<<gridsz, blocksz, sharedmemsz*sizeof(float)>>>(
      ...
      batch, dim_l, dim_0, dim_1, dim_2,
      x_0, x_1, x_2, dy_0, dy_1, dy_2, P_000, P_011, P_101, P_110, P_220, P_222, P_211,
      dleft_000, dleft_011, dleft_101, dleft_110, dleft_220, dleft_222, dleft_211);
...
void fused_tensor_prods_example_wtsback_kern(
    ...
    float* __restrict__ dP_000, float* __restrict__ dP_011, float* __restrict__ dP_101, float* __restrict__ dP_110, float* __restrict__ dP_220, float* __restrict__ dP_222, float* __restrict__ dP_211) {
  extern __shared__ float s[];
...
void fused_tensor_prods_example_wtsback(
  ...
  fused_tensor_prods_example_wtsback_kern<<<gridsz, blocksz, sharedmemsz*sizeof(float)>>>(
      ...
      batch, dim_l, dim_0, dim_1, dim_2,
      x_0, x_1, x_2, dy_0, dy_1, dy_2, left_000, left_011, left_101, left_110, left_220, left_222, left_211,
      dP_000, dP_011, dP_101, dP_110, dP_220, dP_222, dP_211);
